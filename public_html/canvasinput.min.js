...
(function() {
  ...
  var CanvasInput = window.CanvasInput = function(o) {
    ...
    self._hiddenInput.style.left = -self._width;
    self._hiddenInput.style.top = -self._height;
...
//return self.render();
    ...
    _calcWH: function() {
      ...
      // calculate the full width and height with padding, borders and shadows
      self.outerW = self._width + self._borderWidth * 2 + self.shadowW;
      self.outerH = self._height + self._borderWidth * 2 + self.shadowH;
    },
...
//      }
    ...
    _mousePos: function(e) {
      ...
      return {
        x: localToWorld(e.offsetX* (initWidth/ctx.canvas.width), "x"),
        y: localToWorld(e.offsetY* (initWidth/ctx.canvas.width), "y")
      };
    }
  };
})();